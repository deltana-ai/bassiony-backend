    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'App\Interfaces\CompanyProductRepositoryInterface' => \App\Repositories\CompanyProductRepository::class,
            ...
            'App\Interfaces\LocationRepositoryInterface' => \App\Repositories\LocationRepository::class,
            ...
            'App\Interfaces\PharmacyProductRepositoryInterface' => \App\Repositories\PharmacyProductRepository::class,
...
'auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider','auth.guards.users.driver','auth.guards.users.provider',
'auth.guards.admins.driver','auth.guards.admins.provider','auth.guards.pharmacists.driver','auth.guards.pharmacists.provider','auth.guards.sanctum.driver',
...
'auth.providers.pharmacists.driver','auth.providers.pharmacists.model','auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire',
...
'auth.passwords.pharmacists.provider','auth.passwords.pharmacists.table','auth.passwords.pharmacists.expire','auth.passwords.pharmacists.throttle','auth.password_timeout',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.C:\\wamp64\\www\\bassiony-backend\\public\\storage','logging.default',
...
'pharmacist.index','pharmacist.store','pharmacist.show','pharmacist.update','pharmacist.destroy',
'brands.store','brands.show','brands.update',
'categories.store','categories.show','categories.update',
'offer.index','offer.store','offer.show','offer.update','offer.destroy','admin.index','admin.store','admin.show','admin.update',
'admin.destroy','contactus.index','contactus.store','contactus.show',
'contactus.update','contactus.destroy','slider.index',
'slider.store','slider.show','slider.update','slider.destroy',
'product.index','product.store','product.show','product.update','product.destroy','products.index','products.store','products.show','products.update',
'products.destroy','rateing.index','rateing.store','rateing.show','rateing.update',
'rateing.destroy','rate.store','rate.show','rate.update',
'favorites.index','favorites.store','favorites.destroy','addresses.index','addresses.store','addresses.show','addresses.update',
'addresses.destroy','pharmacies.index','pharmacies.store',
'pharmacies.show','pharmacies.update','pharmacies.destroy','branches.index','branches.store',
'branches.show','branches.update','branches.destroy','products.index','products.store',
'products.show','products.update','products.destroy',
'locations.index','locations.store','locations.show','locations.update','locations.destroy',
'warehouses.index',
'warehouses.index','warehouses.store','warehouses.show','warehouses.update','warehouses.destroy',
'warehouses.index',
'companies.index','companies.store','companies.show','companies.update','companies.destroy','register','login','password.email',
'password.store','verification.verify','verification.send','logout',);
