...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\bassiony-backend\public\storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.C:\\xampp\\htdocs\\bassiony-backend\\public\\storage','logging.default','logging.deprecations.channel',
...
'offer.index','offer.store','offer.show','offer.update','offer.destroy',
...
'pharmacies.show','pharmacies.update','roles.index',
'roles.store','roles.show','roles.update','product.store',
'product.show','product.update','companies.store','companies.show','companies.update',
'company.warehouses.index','company.','company.','company.','company.',
'company.warehouses.store','company.warehouses.show','company.warehouses.update','company.','company.',
'company.roles.index','company.','company.','company.roles.store','company.roles.show',
'company.roles.update','company.','company.brands.show','company.','company.categories.show',
...
'company.warehouse.products.index','company.','company.','company.','company.',
'company.products.show','company.','company.','company.','company.',
'company.','company.','company.','company.','company.',
'company.','company.','company.offers.store','company.offers.show','company.offers.update',
'company.','company.','company.','company.','company.',
'company.','company.','company.','company.profile.update','company.',
'company.','pharmacy.','pharmacy.brands.show','pharmacy.','pharmacy.categories.show',
'pharmacy.','pharmacy.','pharmacy.','pharmacy.','pharmacy.',
'pharmacy.pharmacist.store','pharmacy.pharmacist.show','pharmacy.pharmacist.update','pharmacy.','pharmacy.companies.show',
'pharmacy.roles.index','pharmacy.','pharmacy.','pharmacy.roles.store','pharmacy.roles.show',
'pharmacy.roles.update','pharmacy.','pharmacy.','pharmacy.','pharmacy.',
'pharmacy.','pharmacy.branches.store','pharmacy.branches.show','pharmacy.branches.update','pharmacy.warehouse.products.index',
'pharmacy.','pharmacy.','pharmacy.','pharmacy.','pharmacy.',
...
'pharmacy.response-company-offers.update','pharmacy.','pharmacy.user-orders.show','pharmacy.user-orders.update','pharmacy.user-orders.destroy','company.products',
...
'C:.xampp.htdocs.bassiony-backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.xampp.htdocs.bassiony-backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
