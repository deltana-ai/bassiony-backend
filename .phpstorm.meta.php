...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\H_E\Desktop\bassiony\bassiony-backend\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.C:\\Users\\H_E\\Desktop\\bassiony\\bassiony-backend\\public\\storage','logging.default',
...
'user.index','brands.store','brands.show','brands.update','categories.store','categories.show','categories.update','user.store','user.show','user.update',
'user.destroy','admin.index','admin.store',
'admin.show','admin.update','admin.destroy','contactus.index','contactus.store',
'contactus.show','contactus.update','contactus.destroy',
'slider.index','slider.store','slider.show','slider.update','slider.destroy','product.index','product.store','product.show','product.update',
'product.destroy','register',
...
'C:.Users.H_E.Desktop.bassiony.bassiony-backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.Users.H_E.Desktop.bassiony.bassiony-backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'PHP_CLI_SERVER_WORKERS','CACHE_DRIVER','QUEUE_CONNECTION','BCRYPT_ROUNDS','LOG_CHANNEL',
...
'FILESYSTEM_DISK','QUEUE_CONNECTION','CACHE_DRIVER','CACHE_STORE','CACHE_PREFIX',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','FIREBASE_CREDENTIALS',);
