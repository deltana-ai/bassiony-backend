...
'hashing.argon.verify','hashing.rehash_on_login','view.paths','view.compiled','permission.models.permission',
...
'signed','throttle','verified','employee.role',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','telescope',
'user.index','user.store','user.show',
'user.update','user.destroy','pharmacist.index','pharmacist.store','pharmacist.show',
'pharmacist.update','pharmacist.destroy','offer.index','offer.store','offer.show','offer.update',
'offer.destroy',
'products.index','products.store','products.show','products.update','products.destroy',
'rateing.index','rateing.store','rateing.show','rateing.update','rateing.destroy','rate.store','rate.show',
'rate.update','favorites.index','favorites.store','favorites.destroy','addresses.index','addresses.store',
'addresses.show','addresses.update','addresses.destroy',
'branches.index','branches.store','branches.show','branches.update','branches.destroy','admin.store','admin.show',
'admin.update','brands.store','brands.show',
'brands.update','categories.store','categories.show','categories.update','contactus.show',
'contactus.update','slider.store','slider.show','slider.update','pharmacies.store','pharmacies.show','pharmacies.update',
'product.store','product.show','product.update','companies.store','companies.show',
'companies.update','company.warehouses.index','company.','company.','company.',
'company.','company.warehouses.store','company.warehouses.show','company.warehouses.update','company.warehouses.destroy',
'company.','company.','company.roles.index','company.','company.',
'company.','company.roles.store','company.roles.show','company.roles.update','company.roles.destroy',
'company.employees.index','company.','company.','company.','company.',
'company.','company.','company.employees.store','company.employees.show','company.employees.update',
'company.employees.destroy','company.warehouse.products.index','company.','company.products.index','company.products.store',
'company.products.show','company.products.update','company.products.destroy','company.','company.',
'company.','company.','company.','company.offers.store','company.offers.show',
'company.offers.update','company.','company.','company.','company.',
'company.','company.','company.','company.profile.update','company.',
'pharmacy.','pharmacy.companies.show','pharmacy.','pharmacy.','pharmacy.',
'pharmacy.','pharmacy.company-offers.show','pharmacy.','pharmacy.user-orders.show','pharmacy.user-orders.update',
'pharmacy.user-orders.destroy','register','login',
